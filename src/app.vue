                ...
                <div class="columns">
                    <div class="column">
                        ...
                        <form @submit.prevent="update">
                            ...
                            <div class="field">
                                <label for="sel-dictionary" class="label"
                                    >Dictionary</label
                                >
                                <div class="control">
                            ...
                            <div class="field">
                                <label for="inp-words" class="label"
                                    >Words count</label
                                >
                                <div class="control">
                                    <input
                            ...
                            <div class="field">
                                <label for="inp-digits" class="label"
                                    >Digits count</label
                                >
                                <div class="control">
                                    <input
                            ...
                            <div class="field">
                                <label for="sel-case" class="label"
                                    >Word case</label
                                >
                                <div class="control">
                                    <div class="select is-fullwidth">
                            ...
                            <div class="field">
                                <label for="sel-delimiter" class="label"
                                    >Delimiter</label
                                >
                                <div class="control">
                                    <div class="select is-fullwidth">
